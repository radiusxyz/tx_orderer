    ...
    fn initialize_validation_service_manager_client(
        ...
        match validation_info {
            ValidationInfo::EigenLayer(payload) => {
                crate::clients::validation_service_manager::eigenlayer::ValidationServiceManagerClient::initialize(
                    context.clone(),
                    platform,
                    provider,
                    payload,
            ...
            ValidationInfo::Symbiotic(payload) => {
                crate::clients::validation_service_manager::symbiotic::ValidationServiceManagerClient::initialize(
                    context.clone(),
                    platform,
                    provider,
                    payload,
