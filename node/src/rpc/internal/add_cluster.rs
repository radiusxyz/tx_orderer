...
use crate::{clients::liveness_service_manager::radius::{initialize_new_cluster, LivenessServiceManagerClient}, rpc::prelude::*};
    ...
    async fn handler(self, context: AppState) -> Result<Self::Response, RpcError> {
        ...
        match self.platform {
            Platform::Ethereum => {
                ...
                let liveness_service_manager_client: LivenessServiceManagerClient = context
                .get_liveness_service_manager_client::<LivenessServiceManagerClient>(
                    self.platform,
                    self.liveness_service_provider,
                )
                .await?;
